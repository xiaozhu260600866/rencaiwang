<template>
  <div>
    ...
    <my-class ref="category1" top="2%" type="0" form-action="/admin/policy/" :sizearr="300" :class-children-hidden="false" :canupload="true" />
    <my-class ref="category2" top="2%" type="1" form-action="/admin/policy/" :sizearr="300" :class-children-hidden="true" :canupload="true" no="true" />
  </div>
</template>
