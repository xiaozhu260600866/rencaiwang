<template>
  <div>
    <dx-table :data="data" :global-data="globalData" :operate-width="280" @createBeforeCallBack="createBeforeCallBack" />
  </div>
</template>
<script type="text/javascript">
    import globalData from './layouts/horse.js'
    export default {
        components: {
