<template>
	<view>
		...
		<view v-if="data.show">
			...
			<!-- 广告位 -->
			<view class="ad">
				<image class="w-b100 flex" src="https://rencaiwang.doxinsoft.com/images/wap/banner-tz2.jpg" mode="widthFix"></image>
			</view>
			
			<!-- 搜索 -->
			<search @callBack="searchTitle" typeShow :fclass="data.class" @callBackClass="callBackClass"></search>
...
<script>
	...
	export default {
		...
		methods: {
			...
			gotoUrl(item){
				this.postAjax('/innovate/show',item);
